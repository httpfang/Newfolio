...
export default function Hero() {
  ...
  return (
    <>
          ...
          <div ref={menuRef} className="fixed inset-0 z-[100] bg-[#e8defa] text-[#1a1a1a] overflow-y-auto">
            <div className="flex flex-col h-full min-h-screen">
              ...
              <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-black/10">
                <span className="text-[10px] sm:text-xs tracking-widest uppercase">{PERSONAL_INFO.name || 'Portfolio'}</span>
                <button
              ...
              <div className="relative flex-1">
                ...
                <div className="md:hidden flex flex-col items-center justify-center h-full px-4 space-y-6 sm:space-y-8">
                  {NAV_ITEMS.map((item) => (
                    <button
                      ...
                      onTouchStart={(e) => {
                        gsap.to(e.currentTarget, { scale: 0.95, duration: 0.15, ease: 'power2.out', overwrite: 'auto' });
                      }}
                      onTouchEnd={(e) => {
                        gsap.to(e.currentTarget, { scale: 1, duration: 0.15, ease: 'power2.inOut', overwrite: 'auto' });
                      }}
                    >
                ...
                <div className="hidden md:block relative h-full">
                  {NAV_ITEMS.map((item, idx) => {
                    const positions = [
                      { top: '10%', left: '8%', rotate: -6, size: 'text-7xl lg:text-8xl' },
                      { top: '28%', left: '36%', rotate: 8, size: 'text-6xl lg:text-7xl' },
                      { top: '58%', left: '14%', rotate: -3, size: 'text-8xl lg:text-9xl' },
                      { top: '22%', left: '72%', rotate: 6, size: 'text-7xl lg:text-8xl' },
                      { top: '70%', left: '48%', rotate: -7, size: 'text-6xl lg:text-7xl' },
                      { top: '45%', left: '84%', rotate: 3, size: 'text-5xl lg:text-6xl' },
                    ];
      ...
      <section
        id="home"
        className="relative flex items-center px-4 sm:px-6 md:px-10 mt-6 sm:mt-8 md:mt-12 pt-8 sm:pt-12 md:pt-16 pb-20 sm:pb-24 md:pb-20"
      >
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="relative mt-8 sm:mt-10 md:mt-[280px] lg:mt-[320px]">
          {/* Headline */}
          <h1 className="text-[#1C1B1A] font-black tracking-tight leading-[1.1] text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
            <SplitText
              text="Overclocked and"
              className="block"
              delay={100}
              duration={0.9}
            />
          ...
          {/* Subcopy */}
          <p className="mt-3 sm:mt-4 md:mt-5 max-w-2xl text-[#4A4947] text-base sm:text-lg md:text-xl leading-relaxed">
