          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {repos.map((repo, index) => (
              <div
                ...
                className="repo-card-inner font-mono translate-x-[-6px] translate-y-[-6px] bg-[#ff66a3] border-[3px] border-black shadow-[12px_12px_0_#000000] overflow-hidden transition-all duration-300 hover:translate-x-[-6px] hover:translate-y-0 cursor-pointer"
              >
